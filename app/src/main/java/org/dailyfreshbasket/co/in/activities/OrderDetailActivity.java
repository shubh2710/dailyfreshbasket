...
import org.dailyfreshbasket.co.in.adapters.RecycleViewAdapterRowDetail;
import org.dailyfreshbasket.co.in.models.MyOrderDetailProduct;
...
import static org.dailyfreshbasket.co.in.informations.GetDomain.KEYS.URL_GETORDER;
...
public class OrderDetailActivity extends AppCompatActivity implements getResponce {
    ...
    private TextView tv_o_no,tv_o_id,tv_o_date,tv_o_amt,tv_o_stats,tv_o_placeDate,tv_o_charge;
    ...
    private void setup() {
        tv_o_charge=(TextView)findViewById(R.id.tv_order_detail_chargers);
    ...
    public void parseOrder(JSONArray order){
        try {
            ...
            tv_o_placeDate.setText("delivered On:"+delivary);
    ...
    public void parseAddress(JSONObject address){
        ...
        try {
            ...
            String charge=address.getString("charge");
            tv_o_charge.setText(charge+" Rs");
