...
import org.dailyfreshbasket.co.in.adapters.RecycleViewAdapterSmilerProduct;
import org.dailyfreshbasket.co.in.informations.Products_in_Search_details;
import org.dailyfreshbasket.co.in.models.product;
...
public class ShowCase extends AppCompatActivity implements BaseSliderView.OnSliderClickListener, ViewPagerEx.OnPageChangeListener, View.OnClickListener, getResponce {
    ...
    private TextView tv_name,tv_subname,tv_mrp,tv_offer,tv_rate,tv_quantity,tv_discount,tv_mrp_new,tv_specs;
   ...
   private RecycleViewAdapterSmilerProduct adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
                ...
                pd = ProgressDialog.show(this, "Getting Product", "Please wait...");
...
//        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_SEARCH,
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_GET_PRODUCT,
            ...
            protected Map<String,String> getParams(){
                ...
                //working in release mode// changing for new similar product api
//                params.put("key","SEARCH");
//                params.put("searchkey",search);
//                params.put("page","1");
//                params.put("sort","0");
                params.put("pid",pid);
                params.put("key","getSimilar");
                params.put("uid","");
                params.put("email","");
                params.put("password","");
            ...
            if(result) {
                ...
                if (!response.isNull("data")) {
                    ...
                    for (int i = 0; i < Productarray.length(); i++) {
                        ...
                        String product_specs = currentObjecr.getString("specs");
    ...
    public void setup(){
        ...
        tv_mrp_new=(TextView)findViewById(R.id.tv_productMrp);
    ...
    public void setdata(product p){
        ...
        try {
            tv_mrp_new.setText("Rs "+p.getPmrp());
            tv_mrp_new.setPaintFlags(tv_mrp_new.getPaintFlags() | Paint.STRIKE_THRU_TEXT_FLAG);
        }catch (Resources.NotFoundException nf){
            nf.printStackTrace();
            Log.d("NOTFOUND",nf.toString());
        }
        rb.setRating(p.getPrating());
        if(p.getPquantity()>0)
        tv_quantity.setText(Html.fromHtml("<Strong>In Stock:</STRONG> "+p.getPquantity()));
        else{
        ...
        tv_discount.setText((p.getPdiscount())+"% Off");
        tv_rate.setText("Rs "+(String.valueOf(p.getPactualprice())));
tv_specs.setText(p.getPspecs());
