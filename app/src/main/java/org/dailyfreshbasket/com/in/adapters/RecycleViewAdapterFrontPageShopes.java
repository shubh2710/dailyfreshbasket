...
import static org.dailyfreshbasket.com.in.informations.GetDomain.KEYS.URL_LOGIN;
...
public class RecycleViewAdapterFrontPageShopes extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public RecycleViewAdapterFrontPageShopes(Context context){
    ...
    public  RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch(viewType){
            case USER:
                ...
                viewHolder=new RecycleViewAdapterFrontPageShopes.MyViewHolder1(view);
                break;
            case IMAGE:
                View view2=inflater.inflate(R.layout.sliderlayout,parent,false);
                viewHolder=new RecycleViewAdapterFrontPageShopes.MyViewHolder2(view2);
                break;
        }
               return viewHolder;
    }
    ...
    public class MyViewHolder1 extends RecyclerView.ViewHolder{
        ...
        private HorizontalRecycleViewAdapterForFrontShopes RecyclerViewadaptor;
    ...
    public MyViewHolder1(View itemView) {
        ...
        RecyclerViewadaptor=new HorizontalRecycleViewAdapterForFrontShopes(context);
...
public class MyViewHolder2 extends RecyclerView.ViewHolder implements BaseSliderView.OnSliderClickListener, ViewPagerEx.OnPageChangeListener {
    ...
    public  void updateBanners(){
        ...
        JsonObjectRequest request=new JsonObjectRequest(Request.Method.GET,URL_LOGIN, new Response.Listener<JSONObject>() {
            @Override
...
public  class RecyclerTouchListner implements RecyclerView.OnItemTouchListener {
        ...
        private RecycleViewAdapterFrontPageShopes.ClickListener clicklistner;
        public RecyclerTouchListner(Context context, final RecyclerView recyclerview, final RecycleViewAdapterFrontPageShopes.ClickListener clicklistner) {
