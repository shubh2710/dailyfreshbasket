...
import org.dailyfreshbasket.com.in.activities.ForgetPasswordActivity;
...
public class Fragment_LogInForm extends Fragment implements View.OnClickListener, getResponce {
    ...
    public void signIn(){
        ...
        else {List<AuthUI.IdpConfig> providers = Arrays.asList(new AuthUI.IdpConfig.GoogleBuilder().build());
...
// Create and launch sign-in intent
    ...
    public void setdate(String email,String name ,String uid,String guid,String profilepic,boolean login,String password){
        ...
        if(guestid.length()>5)
            ...
            Toast.makeText(getActivity(),"can't log you in",Toast.LENGTH_LONG).show();
        }
    }
