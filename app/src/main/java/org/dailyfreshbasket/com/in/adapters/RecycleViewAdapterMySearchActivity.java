...
import org.dailyfreshbasket.com.in.activities.PlaceNowActivity;
...
public class RecycleViewAdapterMySearchActivity extends RecyclerView.Adapter<RecycleViewAdapterMySearchActivity.MyViewHolder> implements getResponce {
    ...
    public void onBindViewHolder(final MyViewHolder holder,final int position) {
        ...
        holder.tv_rate.setText(currentdata.getProduct_actualprice());
        holder.tv_subname.setText(currentdata.getFeatures());
        holder.tv_mrp.setText(currentdata.getProduct_mrp()+"");
        ...
        holder.tv_dicount.setText(discount+"%");
        holder.tv_mrp.setText(currentdata.getProduct_mrp()+" Rs");
