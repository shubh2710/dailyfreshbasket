...
public class CustomAdapterForListViewUserDatailDrawer extends BaseAdapter {
    String [] result;
    Context context;
    int [] imageId;
    private static LayoutInflater inflater=null;
    public CustomAdapterForListViewUserDatailDrawer(Context mainActivity, String[] prgmNameList, int[] prgmImages) {
