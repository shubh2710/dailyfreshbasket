...
import org.dailyfreshbasket.com.in.activities.CancelOrderActivity;
import org.dailyfreshbasket.com.in.activities.OrderDetailActivity;
...
import static org.dailyfreshbasket.com.in.informations.GetDomain.KEYS.URL_UPDATEORDER;
...
public class RecycleViewAdapterMyOrderList  extends RecyclerView.Adapter<RecycleViewAdapterMyOrderList.MyViewHolder> implements getResponce {
    ...
    public void onBindViewHolder(RecycleViewAdapterMyOrderList.MyViewHolder holder,final int i) {
        ...
        if(currentdata!=null){
            ...
            holder.tv_rs.setText(currentdata.getAmount()+" Rs");
